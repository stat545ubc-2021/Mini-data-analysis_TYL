...
```
(Q1.2.1) Answer: 
I choose question-1 and question-
```{r}
...
Ans1.2.1_d <-VanTreeUBC %>% 
  ...
  filter(n>=quantile(Ans1.2.1_d$n,probs=0.95))
head(Ans1.2.1)
...
ggplot(data=data.frame(x=Ans1.2.1_y$tree_age, y=Ans1.2.1_d$diameter_max),aes(x=x,y=y))
