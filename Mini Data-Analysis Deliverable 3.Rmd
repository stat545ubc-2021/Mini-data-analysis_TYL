...
In this section, I printed out the 

The species name is "**SERRULATA**". The slope, intercept, and R-squared values are shown above. Basically, the diameters of **SERRULATA** became larger when the trees got older. However, we can see that there is a vertical cluster at the right end of the plot. Hence, the diameters were influenced by not only tree ages but also other variables. If we want to know the reason for the vertical cluster on the right end of the plot, we need to further study it.
